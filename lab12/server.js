...
MongoClient.connect(`mongodb://cs336:${process.env.MONGO_PASSWORD}@ds021356.mlab.com:21356/cs336`, function (err, client) {
  if (err) throw err
...
app.post('/api/comments', function(req, res) {
		...
		db.collection('comments').insertOne( { "id": Date.now(),
